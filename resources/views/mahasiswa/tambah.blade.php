			...
			<div class="ibox-content">
				<form class="form-horizontal" method="POST" action="{{ route('mahasiswa.store') }}">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input  class="form-control" value="{{ old("nim") }}" name="nim" value="" >
						</div>
					</div>
					<div class="form-group">
						<label for="" class="control-label col-lg-2">Nama</label>
						<div class="col-lg-10">
							<input  class="form-control" name="nama_mhs" value="{{ old("nama_mhs") }}" >
						</div>
					</div>
					<div class="form-group">
						<label for="" class="control-label col-lg-2">Jenis Kelas</label>
						<div class="col-lg-10">
							<input  class="form-control" name="jenis_kelas" value="{{ old("jenis_kelas") }}" >
						</div>
					</div>
					<div class="form-group">
