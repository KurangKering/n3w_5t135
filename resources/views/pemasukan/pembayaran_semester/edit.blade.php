					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input readonly class="form-control" id="program_studi" value="{{ $detail->pembayaran_semester->mahasiswa->calon_mahasiswa->program_studi }}" >
								</div>
							</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input readonly class="form-control" id="nama_mhs"  value="{{ $detail->pembayaran_semester->mahasiswa->calon_mahasiswa->nama }}">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="control-label col-lg-3">Angkatan</label>
								<div class="col-lg-8">
									<input readonly class="form-control" id="angkatan" value="{{ $detail->pembayaran_semester->mahasiswa->calon_mahasiswa->tahun_masuk }}">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="ibox-title">
				...
				<form method="POST" action="{{ route('pembayaran_semester.update', $detail->id) }}" class="form-horizontal">
					<div class="ibox-content">
						...
						<div class="form-group">
							<label class="control-label col-lg-2">Sisa Bayar</label>
							<div class="col-lg-10">
								<input type="text" readonly value="{{ rupiah($sisa_bayar) }}" class="form-control">
							</div>
						</div>
						<div class="form-group">
	...
	$(document).ready(function() {
		...
		$('form').submit(function(e) {
			...
			if (valJumlah > valSisa) {
				error = 'Jumlah Lebih Besar dari Sisa';
			} 
			if (valJumlah == '0') {
				error = 'Periksa Inputan';
			}
			if (error) 
			{
